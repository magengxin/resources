...
//  getZhiHuiBaodianData(power_monitor_1,option,2);
    getNewZhiHuiBaodianData(power_monitor_1,option,2);
}
/**
 * 智慧保电 
 * 一级用户
...
//  getZhiHuiBaodianData(power_monitor_2,option,1);
    getNewZhiHuiBaodianData(power_monitor_2,option,1);
}
/**
 * 智慧保电 
 * 核心配电站
...
//  getZhiHuiBaodianData(power_monitor_3,option,3);
    getNewZhiHuiBaodianData(power_monitor_3,option,3);
}
/**
 * 业务指挥下
 * 巡视任务 异常处理 紧急处理 
...
function dashBoard() {
    ...
    getYeWuZhiHuData(dashBoard,option);
}
/**
 * 资源监控
 */
...
//  ziYuanJianKongData(left_box,option);
}
...
function load_body(data) {
    ...
    option = {
        ...
        series : [
            ...
            //         }
            //     },
            //     data:[30, 182, 434, 791, 390, 30, 10,390, 30,]
            // },
            // {
            //     name:'新能源',
            //     type:'line',
            ...
            //         }
            //     },
            //     data:[120, 132, 601, 234, 120, 90, 20,234, 120,]
            // },
            // {
            //     name:'总受点',
            //     type:'line',
            ...
            //         }
            //     },
            //     data:[23, 551, 456, 287, 654, 910, 220,156,221]
            // }
        ]
    };
