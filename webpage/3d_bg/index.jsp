...
<style>
	...
	<body>
	<div class='bg_wrap' style="width: 11520px;display: flex;">
		...
		<div class="body_box pos-r">
			...
			<div class="center_box overflow_h">
                <!--
                	描述：新明细列表结构开始
                -->
                <div class="bottom-list hide" style="width:3360px">
					...
					<div class="lys_box" style="width: 2900px;">
                ...
                <!--
                	描述：新明细列表结构结束
                -->  
				<img id='picbox' style="position: absolute;top:154px;left: 0;width:2880px;height: 1592px;background: pink;display: none;" />
				<div id='pictitle' style="position: absolute;bottom:414px;left: 0;width:2880px;height: 90px;background: rgba(0,0,0,0.5);text-align: center;display: none;line-height: 90px;font-size: 48px;color:#fff;"></div>
				<!--应急预案显示图片   -->
				...
				<div style="width: 1190px;height: 60px;background: rgba(49,111,151,0.5);color: #FFFFFF;margin-top: 20px;margin-left: 50px;position: absolute;">
					<div style="padding: 5px 60px 5px 30px;position: relative;">
						...
						<img src="${ctx}/ws_static/img/fangan_ac.png" alt="img" width="40" height="40" style="position: absolute;right: 10px;top:10px;">
					</div>
				</div>
				...
				<div class='history' style="display: none;">
					...
					<img src="../../ws_static/img/history_close.png" class='history_close'/>
				...
				<div id="showImgBigDiv" style="opacity: 0;">
					...
					<div id="showImgDiv">
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/sj_05.jpg" alt="" id='0'/><div class='cangkunpic'>松江中心库板货车</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/sj_02.jpg" alt=""  id='1'/><div class='cangkunpic'>松江中心库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/sj_03.jpg" alt=""  id='2'/><div class='cangkunpic'>松江中心库汽车吊</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/sj_04.jpg" alt="" id='3'/><div class='cangkunpic'>松江中心库外景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/sj_01.jpg" alt="" id='4'/><div class='cangkunpic'>松江中心库应急物资</div></li>
								</ul>
						...
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/wzl_01.jpg" alt="" id='5'/><div class='cangkunpic'>吴中路仓库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/wzl_02.jpg" alt="" id='6'/><div class='cangkunpic'>吴中路仓库外景</div></li>
								</ul>
							</div>
							<a class="prev" href="javascript:void(0)"></a>
							<a class="next" href="javascript:void(0)"></a>
						...
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/zyl_01.jpg" alt="" id='7'/><div class='cangkunpic'>闸殷路仓库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/zyl_02.jpg" alt="" id='8'/><div class='cangkunpic'>闸殷路仓库外景</div></li>
								</ul>
							</div>
							<a class="prev" href="javascript:void(0)"></a>
							<a class="next" href="javascript:void(0)"></a>
						...
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/gdl_01.jpg" alt="" id='9'/><div class='cangkunpic'>顾戴路仓库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/gdl_02.jpg" alt="" id='10'/><div class='cangkunpic'>顾戴路仓库外景</div></li>
								</ul>
							</div>
							<a class="prev" href="javascript:void(0)"></a>
							<a class="next" href="javascript:void(0)"></a>
						...
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/dslq_01.jpg" alt="" id='11'/><div class='cangkunpic'>东三里桥路仓库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/dslq_02.jpg" alt="" id='12'/><div class='cangkunpic'>东三里桥路仓库外景</div></li>
								</ul>
							</div>
							<a class="prev" href="javascript:void(0)"></a>
							<a class="next" href="javascript:void(0)"></a>
						...
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/jl_01.jpg" alt="" id='13'/><div class='cangkunpic'>金廊公路仓库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/jl_02.jpg" alt="" id='14'/><div class='cangkunpic'>金廊公路仓库外景</div></li>
								</ul>
							</div>
							<a class="prev" href="javascript:void(0)"></a>
							<a class="next" href="javascript:void(0)"></a>
						...
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/gjl_01.jpg" alt="" id='15'/><div class='cangkunpic'>拱极路仓库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/gjl_02.jpg" alt="" id='16'/><div class='cangkunpic'>拱极路仓库外景</div></li>
								</ul>
							</div>
							<a class="prev" href="javascript:void(0)"></a>
							<a class="next" href="javascript:void(0)"></a>
						...
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/hhgl_01.jpg" alt="" id='17'/><div class='cangkunpic'>沪杭公路仓库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/hhgl_02.jpg" alt="" id='18'/><div class='cangkunpic'>沪杭公路仓库外景</div></li>
								</ul>
							</div>
							<a class="prev" href="javascript:void(0)"></a>
							<a class="next" href="javascript:void(0)"></a>
						...
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/hcl_01.jpg" alt="" id='19'/><div class='cangkunpic'>霍城路仓库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/hcl_02.jpg" alt="" id='20'/><div class='cangkunpic'>霍城路仓库外景</div></li>
								</ul>
							</div>
							<a class="prev" href="javascript:void(0)"></a>
							<a class="next" href="javascript:void(0)"></a>
						...
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/bgl_01.jpg" alt="" id='21'/><div class='cangkunpic'>堡港路仓库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/bgl_02.jpg" alt="" id='22'/><div class='cangkunpic'>堡港路仓库外景</div></li>
								</ul>
							</div>
							<a class="prev" href="javascript:void(0)"></a>
							<a class="next" href="javascript:void(0)"></a>
						...
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/qsl_01.jpg" alt="" id='23'/><div class='cangkunpic'>青松路仓库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/qsl_02.jpg" alt="" id='24'/><div class='cangkunpic'>青松路仓库内景</div></li>
								</ul>
							</div>
							<a class="prev" href="javascript:void(0)"></a>
							<a class="next" href="javascript:void(0)"></a>
						...
						<div class="slideBox">
							<div class="bd">
								<ul>
									<li><img src="${ctx}/ws_static/img/ckimg/hnl_01.jpg" alt="" id='25'/><div class='cangkunpic'>沪南路仓库内景</div></li>
									<li><img src="${ctx}/ws_static/img/ckimg/hnl_02.jpg" alt="" id='26'/><div class='cangkunpic'>沪南路仓库内景</div></li>
								</ul>
							</div>
							<a class="prev" href="javascript:void(0)"></a>
							<a class="next" href="javascript:void(0)"></a>
        ...
        <p> 台区监测 </p>
          ...
          <ul>
            ...
            <li> <span> <img src="${ctx}/ws_static/img/topIcon%20(1).png" alt="Icon" width="36" height="36"> </span> <span>三相不平衡</span> <span class="monitor_top_num">20</span> </li>
								...
								<div class="runbox-block">
									<div class="runbox-block__title">
										...
										<div class="tip2" onclick="javascript:Popup.show('#popup-gzjcfx');gzjc_fbtj_init()">
											<img style="margin-left:65px;margin-top:-2px;" src="${ctx}/ws_static/img/icon_tst.png"/>
										</div>
							...
							<div class="run_box hide run_box_pwyx" id="right_runbox_pwyx">
								<div class="runbox-block">
									<div class="runbox-block__title">
										...
										<div class="tip2" onclick="javascript:Popup.show('#popup-tqjcfx')">
											<img style="margin-left:65px;margin-top:-2px;" src="${ctx}/ws_static/img/icon_tst.png"/>
										</div>
									</div>
									<!-- myselector -->
						...
						<!-- 业务指挥 -->
						<div class="tab_box__item" id="zhihui" style="display:none;position: relative;">
							...
							<div class="monitor_box monitor_box_full monitor_box_full1 pos-r Power_box power_tx">
								...
								<div class="monitor_body">
									...
									<div id="hasDoneViewDiv">
										...
										<div id="hasDonPer">20%</div>
										
									</div>
									<div id="hasDoneViewCount">
										<span id="hasDoneSpan">240</span>
										<!--<div id="divider"></div>
							...
							<div class="clearfix"></div>
							<!-- myselector -->
							<dl class="myselector square_move" style="position: absolute;right: 70px;top:190px;">
								<dt id="areaGZJC">上海</dt>
								<dd onclick="javascript:$(this).parent().find('dt').html($(this).html());get_tztj_ssjc($(this).html())">上海</dd>
								<dd onclick="javascript:$(this).parent().find('dt').html($(this).html());get_tztj_ssjc($(this).html())">检修</dd>
								<dd onclick="javascript:$(this).parent().find('dt').html($(this).html());get_tztj_ssjc($(this).html())">核心</dd>
								<dd onclick="javascript:$(this).parent().find('dt').html($(this).html());get_tztj_ssjc($(this).html())">浦东</dd>
							...
							<div class="monitor_box monitor_box_full pos-r Power_box task_disposal">
									...
									<div class="monitor_body task_disposal_body" style="margin-left:100px;margin-top: 30px;">
										<div style="height: 64px;position: relative;">
											<p>
												<img src="../../ws_static/img/icon_logo_01.png" alt="img" width="64" height="64" style="vertical-align: top;">
										...
										<div style="height: 64px;position: relative;">
											<p>
												<img src="../../ws_static/img/icon_logo_02.png" alt="img" width="64" height="64" style="vertical-align: top;">
		...
		<div class="popup popup-normal popup-gzjcfx" id="popup-gzjcfx">
			...
			<div class="popup-normal__main">
				...
				<div class="popup-normal__timeSelect m_gzjzfx">
					...
					<span class="y" id="l_pop_gzjc_y">2018年</span>
					<span class="m" id="l_pop_gzjc_m" data-month="9">月</span>
				</div>
		...
		<div class="popup popup-normal popup-tqjcfx" id="popup-tqjcfx">
			...
			<div class="popup-normal__main">
				...
				<div class="popup-normal__timeSelect m_tqjcfx ">
					...
					<span class="y">2018年</span>
					<span class="m" data-month="9">月</span>
				</div>
				<dl class="popup-normal__typeSelect popup-normal__yearSelect y_tqjcfx lys_one_wid_change lys_hover" style="display:none;">

					<dt>2018</dt>
					<dd><label><input type="radio" name="radio_tqjcfx_time" value="2017" onclick="initAnaly('-1',$(this).attr('value'))"><span>2017</span></label></dd>
					<dd><label><input type="radio" name="radio_tqjcfx_time" checked value="2018" onclick="initAnaly('-1',$(this).attr('value'))"><span>2018</span></label></dd>
				...
				<div class="popup-normal__typeSelect">
					...
					<label id="qushifenxi"><input type="radio"  name="radio_tqjcfx_type" onclick="javascript:popup_tab_toggle(this,1);popup_tqjcfx_timeToggle(this, 'year')"><span>趋势分析</span></label>
				</div>
				<!-- tab:分布统计 -->
				<div class="popup-normal__tabContent">
				...
				<div class="popup-normal__tabContent" style="display:none;">
					...
					<div class="popup-normal__block popup-tqjcfx__block-ddy">
						<div class="popup-normal__blockTitle">低电压</div>
		...
		<div class='bg_right' style="width:5760px;float: left;height: 2160px;background: #ccc;"></div>
	</div>
	</body>
